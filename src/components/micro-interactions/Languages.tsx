...
export default function Languages() {
  return (
    <div className="grid w-full max-w-60 grid-cols-4 gap-1.5">
        {src.map((src) => (
            <figure className="col-span-1 aspect-square bg-[#f9f9f9] rounded-xl border border-gray flex items-center justify-center p-3 shadow-sm overflow-hidden group">
